...
After these changes, the model training was faster, and it hit all targets correctly much early on (~3000 episodes). The model also remembered past successful episodes. However while it was able to repeat the Target A -> B steps correctly, it

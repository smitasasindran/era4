...
Rewards were incorrect and very high. Car was being incentivised to reach obstacles

2.3 Rewards
Changed the rewards to consider sensor values correctly.
...
Reducing LR to 0.0001: Model crashed a lot during the first 2500 episodes, then learnt to stay on the road for much longer steps. However it seemed to prioritize running for mode steps rather than reaching the targets, so it took the longer route to the targets, especially target A.
